...
class Derain_FasterRCNN(nn.Module):
    ...
    def batch_images(self, images, shape_h, shape_w, dim):
        res = torch.empty(len(images), dim, shape_h, shape_w)
        for i, img in enumerate(images):
            res[i] = transforms.Resize([shape_h, shape_w])(img)
        return res
