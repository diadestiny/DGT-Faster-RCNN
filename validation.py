...
def main(parser_data):
    ...
    # read class_indict
    label_json_path = 'pascal_voc_classes_'+parser_data.data_name+'.json'
    ...
    val_dataset = VOCDataSet(VOC_root, "2012", data_transform["val"], parser_data.val_txt_name,dataset_name=parser_data.data_name)
    ...
    voc_map_info_list = []
    if parser_data.data_name == "kitti":
