...
from nets import MyNet, MyNet_DGNL, MyNet_CFT, DDGN_Depth_CFT_Pred, DDGN_Depth_Pred, DGNLNet
...
def main():
    ...
    net = DDGN_Depth_CFT_Pred().cuda().train()
